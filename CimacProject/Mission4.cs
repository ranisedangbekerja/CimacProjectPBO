...
{
    public partial class Mission4 : Form
    {
        public Mission4()
        {
            InitializeComponent();
        ...
        {
            string f = "C:\\Users\\IamR\\Downloads\\Mission\\Video Mission4.mp4";
            axWindowsMediaPlayer1.URL = f;
        }

        private void Mission4_Load(object sender, EventArgs e)
        {
